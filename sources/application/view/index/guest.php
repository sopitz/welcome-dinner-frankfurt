...
<div class="container">
        ...
        <div class="col-sm-12">
            <div class="page-header">
                <h1>
                    ...
                    <small>
                        <a href="http://gast.welcome-dinner.de/en/guests/new?cookie_test=1460374788">English version</a>
                    </small>
                </h1>
                <h3>
                    Gastgeber können sich <a href="http://anmeldung.welcome-dinner-frankfurt.de/host/register">hier</a> eintragen.
                </h3>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-8">
            ...
            <p>Dann möchten dich Hamburger herzlich willkommen heißen mit einem Abendessen!</p>
            <p>Wie das geht?</p>
            <ol>
        ...
        <div class="col-sm-12">
            ...
            <form action="<?php echo Config::get('URL'); ?>register/guest" method="post">
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input type="text" name="age" placeholder="Alter" required />
                    </div>
                </div>
                <div class="form-group col-md-12">
